...
// function f_calcular_tramos_base_liquidable_comunidad(base_imponible, comunidad){
//     var datos = {
//         // (*) ESTATAL
//         'E':[
//             [0, 12450, 9.5],
...
// function f_comunidades_autonomas (){
//     var ca = [];
//     ca[1] = ["1","AndalucÃ­a"];
//     ca[2] = ["2","AragÃ³n"];
//     ca[3] = ["3","Asturias"];
...
//     var restaurante_gasto = f_format_string_to_number(document.getElementById("restaurante_gasto").value);
//     if((isNaN(restaurante_gasto)) || restaurante_gasto>11 || restaurante_gasto<0) {
//         f_muestra_error("El importe del gasto diario en restaurantes no es un dato correcto. (mÃ¡ximo 11â‚¬)");
//         return false;
//     }
//     respuesta['restaurante_gasto'] = restaurante_gasto;

//     var restaurante_dias = f_format_string_to_number(document.getElementById("restaurante_dias").value);
//     if((isNaN(restaurante_dias)) || restaurante_dias>22 || restaurante_dias<0 ) {
//         f_muestra_error("Los dÃ­as laborables para los gastos de restaurante no es un dato correcto. (mÃ¡ximo 22 dÃ­as)");
//         return false;
//     }
//     respuesta['restaurante_dias'] = restaurante_dias;

//     var gasto_transporte = f_format_string_to_number(document.getElementById("gasto_transporte").value);
//     if((isNaN(gasto_transporte)) || gasto_transporte>136.36 || gasto_transporte<0) {
//         f_muestra_error("El gasto de transporte no es un dato correcto. (mÃ¡ximo 136,36)");
//         return false;
//     }
//     respuesta['gasto_transporte'] = gasto_transporte;


//     respuesta['meses_guarderia'] = document.getElementById("meses_guarderia").value;
//     respuesta['meses_transporte'] = document.getElementById("meses_transporte").value;
//     respuesta['restaurante_meses'] = document.getElementById("restaurante_meses").value;
