...
function checkSubmit(e) {
  ...
  */
  ...
  function f_calcuar_cuota_mensual_pagar(anio, bruto_anual, categoria_profesional) {
  
    var datos = {
      A: [{ min: 1466.40, max: 4070.10 }],
      B: [{ min: 1215.90, max: 4070.10 }],
      C: [{ min: 1050.00, max: 4070.10 }],
      D: [{ min: 1050.00, max: 4070.10 }],
      E: [{ min: 1050.00, max: 4070.10 }],
      F: [{ min: 1050.00, max: 4070.10 }],
      G: [{ min: 1050.00, max: 4070.10 }],
      H: [{ min: 1050.00, max: 4070.10 }],
      I: [{ min: 1050.00, max: 4070.10 }],
      J: [{ min: 1050.00, max: 4070.10 }],
      K: [{ min: 1050.00, max: 4070.10 }]
    };
  ...
  function f_calcular_reduccion_rendimiento_neto(anio, rendimiento_neto) {
    var movilidad_geografica = document.getElementById("movilidad_geografica").checked;
    var minusvalia_33_al_65 = document.getElementById("minusvalia_33_al_65").checked;
    var minusvalia_sup_al_65 = document.getElementById("minusvalia_sup_al_65").checked;
    ...
    return (reduccion_comun_todos + reduccion_rendimiento_neto + incremento_movilidad_geografica + minusvalia_igual_superior_33 + minusvalia_sup_65_o_movilidad_reducida + reduccion_desempleado + reduccion_pesionista);
  ...
  function f_calcular_tramos_base_liquidable(base_liquidable) {
    ...
    if (base_liquidable < 300000) {
      ...
      var tramo_6 = ((base_liquidable - 300000) * 0.47);
    }
  ...
  function f_calcular_tramos_situacion_familiar(situacion_familiar, hijos_menores_25_anos) {
  ...
  function f_calcular_tipo_retencion_minimos_tributacion(situacion_familiar, bruto_anual, tipo_final_retencion_truncado, hijos_menores_25_anos) {
    // recupero los minimos asociados a la situacion familiar
    var minimo_situacion_familiar = f_calcular_tramos_situacion_familiar(situacion_familiar, hijos_menores_25_anos);
  ...
  function f_calcular_tipo_retencion_situacion_contribuyente(anio, tipo_retencion, situacion_familiar, hijos_menores_25_anos, bruto_anual) {
  ...
  function f_calcular_nomina() {
    ...
    var categoria_profesional = document.getElementById("categoria_profesional").value;
    var hijos_en_exclusiva = document.getElementById("hijos_en_exclusiva").checked;
    var minusvalia_33_al_65 = document.getElementById("minusvalia_33_al_65").checked;
    var minusvalia_sup_al_65 = document.getElementById("minusvalia_sup_al_65").checked;
  
    var situacion_familiar = document.getElementById("situacion_familiar").value;
    var tipo_contrato_laboral = document.getElementById("tipo_contrato_laboral").value;
    ...
    if ((isNaN(descendientes_con_minusvalia_33_al_65))) {
      ...
      f_muestra_error("El nÃºmero de descendientes con grado de discapacidad entre 33% y 65%  no es un dato correcto");
      return false;
    }
    ...
    if ((isNaN(descendientes_con_minusvalia_sup_al_65))) {
      ...
      f_muestra_error("El nÃºmero de descendientes con grado de discapacidad superior al 65% no es un dato correcto");
      return false;
    }
    ...
    if ((isNaN(ascendientes_con_minusvalia_33_al_65))) {
      ...
      f_muestra_error("El nÃºmero de ascendientes con grado de discapacidad entre el 33% y el 65% no es un dato correcto");
      return false;
    }
    ...
    if ((isNaN(ascendientes_con_minusvalia_sup_al_65))) {
      ...
      f_muestra_error("El nÃºmero de ascendientes con grado de discapacidad igual o superior al 65% no es un dato correcto");
      return false;
    }
    ...
    var cuota_mensual_pagar = f_calcuar_cuota_mensual_pagar(2017, bruto_anual, categoria_profesional);
    var cuota_acumulado_ano = (cuota_mensual_pagar * 12);
    var rendimiento_neto = bruto_anual - cuota_acumulado_ano;
    var reduccion_rendimiento_neto = f_calcular_reduccion_rendimiento_neto(2017, rendimiento_neto);
    if (hijos_menores_25_anos > 2) {
      reduccion_rendimiento_neto = (reduccion_rendimiento_neto + 600);
    }
  
    var base_imponible = bruto_anual - cuota_acumulado_ano - reduccion_rendimiento_neto;
    ...
    var minimo_descendientes = f_calcular_minimo_descendientes(2017, hijos_menores_25_anos);
    ...
    var suma_minimos = minimo_personal + minimo_hijos_beneficiarios + minimo_hijos_menores_3_anos_beneficiarios + minimo_ascendente_mayor_65_menor_75 + minimo_ascendente_mayor_75 + minimo_menor_65_con_discapacidad_cargo + minimo_descendientes_con_minusvalia_33_al_65_beneficiarios + minimo_descendientes_con_minusvalia_sup_al_65_beneficiarios + minimo_ascendientes_con_minusvalia_33_al_65 + minimo_ascendientes_con_minusvalia_sup_al_65 + minimo_minusvalia_33_al_65 + minimo_minusvalia_sup_al_65;
  
    /* fin paso 2: Calculo del MÃ­n. personal y familiar*/
  
    /* paso3: calcular retenciones */
    var cuota_retencion = (f_calcular_tramos_base_liquidable(base_imponible) - f_calcular_tramos_base_liquidable(suma_minimos)).toFixed(num_decimales);
  
  
    var tipo_previo = ((cuota_retencion / bruto_anual) * 100);
    var tipo_previo_redondeado = ((cuota_retencion / bruto_anual) * 100).toFixed(0);
    var importe_previo_retencion = ((tipo_previo / 100) * bruto_anual).toFixed(num_decimales);
    ...
    var tipo_final_retencion_truncado = truncateNumber((((importe_previo_retencion - deduccion_400_euros) / bruto_anual) * 100), num_decimales);
    ...
    var importe_final_retencion = ((tipo_final_retencion_truncado / 100) * bruto_anual);
    ...
    var tipo_retencion = f_calcular_tipo_retencion_situacion_contribuyente(2017, tipo_final_retencion_truncado, situacion_familiar, hijos_menores_25_anos, bruto_anual);
    ...
    ponerResultado("celda_sueldo_bruto_anual_2017", bruto_anual.toFixed(1), "&euro;");
    ponerResultado("celda_sueldo_neto_anual_2017", sueldo_neto.toFixed(1), "&euro;");
    ponerResultado("celda_retenciones_IRPF_2017", importe_retencion.toFixed(1), "&euro;");
    ...
    if (numero_pagas == "14") {
      ponerResultado("celda_sueldo_neto_2017", salario_mensual.toFixed(1), "&euro;");
      ponerResultado("celda_paga_extra_2017", pagas_extras.toFixed(1), "&euro;");
  
    }
    else {
      ponerResultado("celda_sueldo_neto_2017", sueldo_neto_12_pagas.toFixed(1), "&euro;");
    }
  ...
  function f_enviar_al_ancla() {
    ...
    var ancla_tabla_resultados = document.getElementById("ancla_tabla_resultados");
  ...
  function checkNumPagas() {
    ...
    if (numero_pagas == "14") {
      document.getElementById("fila_paga_extra").innerHTML = '<tr><td class="col_one">Pagas extras (x2)</td><td class="normal"><div id="celda_paga_extra_2017">--</div></td></tr>';
    }
    else {
